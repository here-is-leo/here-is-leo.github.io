const SITE = {
  fa: {
    ...
    stats: [
      ...
      { number: 23, suffix: "", label: "مشارکت (commit) در یک سال" },
    ...
    about: {
      ...
      githubText: "۲۳ مشارکت (commit) در یک سال اخیر، با تمرکز فعالیت در مرداد ۱۴۰۵. بیشترین فعالیت روی پروژه‌های امنیتی و آموزشی.",
  ...
  en: {
    ...
    stats: [
      ...
      { number: 23, suffix: "", label: "Commits in the Past Year" },
    ...
    about: {
      ...
      githubText: "23 commits in the past year, with focused activity in August 2026. Most active on security and educational projects.",
      githubLinkText: "github.com/here-is-leo"
    }
  }
};
